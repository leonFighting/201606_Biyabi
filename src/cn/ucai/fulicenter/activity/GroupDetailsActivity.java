...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        groupMembers = BiyabiApplication.getInstance().getGroupMembers().get(groupId);
        currentUserName = BiyabiApplication.getInstance().getUserName();
        ...
        return new Response.Listener<Group>() {
            ...
            public void onResponse(Group group) {
                if(group!=null && group.isResult()){
                    ...
                    mGroup = group;
                    ArrayList<Group> groupList = BiyabiApplication.getInstance().getGroupList();
    ...
    private void refreshMembers(){
        String groupTitle = mGroup.getMGroupName() + "("+mGroup.getMGroupAffiliationsCount() + ")";
        ((TextView) findViewById(R.id.group_name)).setText(groupTitle);
        ArrayList<Member> list = BiyabiApplication.getInstance().getGroupMembers().get(groupId);
