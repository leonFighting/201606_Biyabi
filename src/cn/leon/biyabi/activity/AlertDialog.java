...
import cn.leon.biyabi.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.biyabi.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.leon.biyabi.R.id.title);
		mButton = (Button) findViewById(cn.leon.biyabi.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.leon.biyabi.R.id.image);
		editText = (EditText) findViewById(cn.leon.biyabi.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.leon.biyabi.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.leon.biyabi.R.id.alert_message)).setVisibility(View.GONE);
