...
import cn.leon.biyabi.adapter.ChatRoomAdapter;
...
public class ChatRoomActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.biyabi.R.layout.fragment_chatroom);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
		roomList = EMChatManager.getInstance().getAllChatRooms();
		chatListView = (ListView) findViewById(cn.leon.biyabi.R.id.list);
