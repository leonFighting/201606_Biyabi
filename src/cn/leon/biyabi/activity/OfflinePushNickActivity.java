...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.leon.biyabi.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.leon.biyabi.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.leon.biyabi.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.leon.biyabi.R.id.tv_nickname_description);
