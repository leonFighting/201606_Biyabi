...
import cn.leon.biyabi.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
					...
					if (success) {
						...
						if (!GroupsActivity.this.isFinishing()) {
							String s1 = getResources()
									.getString(
											cn.leon.biyabi.R.string.Failed_to_get_group_chat_information);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.leon.biyabi.R.layout.fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(cn.leon.biyabi.R.id.list);
		...
		progressBar = (View)findViewById(cn.leon.biyabi.R.id.progress_bar);
