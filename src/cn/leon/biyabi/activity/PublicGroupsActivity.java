...
public class PublicGroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchBtn = (Button) findViewById(cn.leon.biyabi.R.id.btn_search);
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) convertView.findViewById(cn.leon.biyabi.R.id.name)).setText(getItem(position).getGroupName());
