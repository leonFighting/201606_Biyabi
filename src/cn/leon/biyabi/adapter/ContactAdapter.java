	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ViewHolder holder;
 		if(convertView == null){
			...
			holder.unreadMsgView = (TextView) convertView.findViewById(cn.leon.biyabi.R.id.unread_msg_number);
			holder.nameTextview = (TextView) convertView.findViewById(cn.leon.biyabi.R.id.name);
			holder.tvHeader = (TextView) convertView.findViewById(cn.leon.biyabi.R.id.header);
		...
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
			...
			holder.avatar.setDefaultImageResId(cn.leon.biyabi.R.drawable.new_friends_icon);
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
			...
			//群聊item
		    holder.nameTextview.setText(user.getMUserNick());
			holder.avatar.setDefaultImageResId(cn.leon.biyabi.R.drawable.groups_icon);
			holder.avatar.setImageUrl("", RequestManager.getImageLoader());
	...
	public Object[] getSections() {
		...
		list.add(mContext.getString(cn.leon.biyabi.R.string.search_header));
