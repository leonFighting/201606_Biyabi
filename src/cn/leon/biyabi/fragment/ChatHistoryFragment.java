...
import cn.leon.biyabi.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.leon.biyabi.R.layout.fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		errorText = (TextView) errorItem.findViewById(cn.leon.biyabi.R.id.tv_connect_errormsg);
		// contact list
		...
		final String st = getResources().getString(cn.leon.biyabi.R.string.Cant_chat_with_yourself);
		listView.setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				EMContact emContact = adapter.getItem(position);
				if (adapter.getItem(position).getUsername().equals(BiyabiApplication.getInstance().getUserName()))
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(cn.leon.biyabi.R.menu.delete_message, menu);
		// }
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.leon.biyabi.R.id.delete_message) {
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), cn.leon.biyabi.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
