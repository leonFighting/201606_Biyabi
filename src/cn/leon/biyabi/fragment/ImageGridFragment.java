...
import cn.leon.biyabi.BuildConfig;
import cn.leon.biyabi.activity.RecorderVideoActivity;
import cn.leon.biyabi.domain.VideoEntity;
import cn.leon.biyabi.video.util.ImageCache;
import cn.leon.biyabi.video.util.ImageResizer;
import cn.leon.biyabi.video.util.Utils;
import cn.leon.biyabi.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				cn.leon.biyabi.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				cn.leon.biyabi.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(cn.leon.biyabi.R.drawable.empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(cn.leon.biyabi.R.layout.image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(cn.leon.biyabi.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(cn.leon.biyabi.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(cn.leon.biyabi.R.layout.choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(cn.leon.biyabi.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(cn.leon.biyabi.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(cn.leon.biyabi.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(cn.leon.biyabi.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(cn.leon.biyabi.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(cn.leon.biyabi.R.drawable.actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(cn.leon.biyabi.R.drawable.empty_photo);
